...
<head>
    ...
    <title>Collabora - Passione Calabria</title>
...
<body class="bg-gray-100">
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold text-center text-gray-800 mb-8">Collabora con Noi</h1>
        <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <?php if ($form_submitted): ?>
                <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4" role="alert">
                    <p class="font-bold">Grazie!</p>
                    <p>La tua proposta di collaborazione è stata inviata con successo. Ti contatteremo al più presto.</p>
                </div>
            <?php else: ?>
                <p class="text-gray-600 mb-6">Sei un appassionato della Calabria e vuoi contribuire al nostro progetto? Compila il modulo sottostante per inviarci la tua proposta di collaborazione.</p>
                <?php if ($form_error): ?>
                ...
                <form action="collabora.php" method="POST">
                    ...
                    <div class="text-center">
                        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Invia</button>
                    </div>
                </form>
            <?php endif; ?>
        </div>
