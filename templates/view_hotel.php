        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:items-start">
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Dettagli Struttura</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <?php if (!empty($services)): ?>
                            <div>
                                <h4 class="font-semibold text-gray-700">Servizi Principali</h4>
                        ...
                        <?php if (!empty($json_data['booking_link'])): ?>
                            <div>
                                <h4 class="font-semibold text-gray-700">Prenotazioni</h4>
                                 <a href="<?php echo htmlspecialchars($json_data['booking_link']); ?>" target="_blank" class="text-blue-600 hover:underline">Prenota ora</a>
                            </div>
                        <?php endif; ?>
