        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:items-start">
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                    <h3 class="text-xl font-bold mb-4 text-gray-800">Dettagli Servizio di Trasporto</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php if (!empty($json_data['service_type'])): ?>
                            <div>
                                <h4 class="font-semibold text-gray-700">Tipo di Servizio</h4>
                                <p class="text-gray-600"><?php echo htmlspecialchars($json_data['service_type']); ?></p>
                            </div>
                        <?php endif; ?>

                        <?php if (!empty($json_data['routes_covered'])): ?>
                            <div>
                                <h4 class="font-semibold text-gray-700">Tratte Coperte</h4>
                                <p class="text-gray-600 whitespace-pre-line"><?php echo htmlspecialchars($json_data['routes_covered']); ?></p>
                            </div>
                        <?php endif; ?>

                        <?php if (!empty($json_data['timetables'])): ?>
                            <div>
                                <h4 class="font-semibold text-gray-700">Orari</h4>
                                <p class="text-gray-600 whitespace-pre-line"><?php echo htmlspecialchars($json_data['timetables']); ?></p>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if (!empty($json_data['website_link'])): ?>
                            <div>
                                <h4 class="font-semibold text-gray-700">Sito Web per Orari e Biglietti</h4>
                                <a href="<?php echo htmlspecialchars($json_data['website_link']); ?>" target="_blank" class="text-blue-600 hover:underline">Consulta il sito ufficiale</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
