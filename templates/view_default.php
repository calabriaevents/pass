    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:items-start">
            ...
            <div class="lg:col-span-2 space-y-12">
                <!-- Description -->
                <section>
                    <h2 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Descrizione</h2>
            ...
            <aside class="lg:col-span-1 sticky top-8">
                <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                    ...
                    <?php if($maps_link): ?>
                    <div class="mt-6 rounded-lg overflow-hidden border border-gray-200 shadow-md">
                        <iframe
                            src="<?php echo $maps_link; ?>"
                            width="100%"
                            height="300"
                            style="border:0;"
                            allowfullscreen=""
