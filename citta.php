...
<head>
    ...
    <title>Città della Calabria - Passione Calabria</title>
    <meta name="description" content="Esplora tutte le città della Calabria: dalle grandi metropoli ai piccoli borghi, scopri la diversità urbana calabrese.">
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item text-gray-900 font-medium">Città</span>
            </nav>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-blue-600 via-teal-500 to-yellow-500 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
                Dalle grandi metropoli costiere ai piccoli borghi montani, scopri la diversità urbana che caratterizza la Calabria. 
                Ogni città racconta una storia unica fatta di tradizioni, cultura e bellezze naturali.
            </p>
            <div class="flex justify-center gap-4 flex-wrap">
                <span class="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full">
                    <?php echo $totalCities; ?> <span>città totali</span>
                </span>
                <span class="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Cerca città</label>
                    <input
                        type="text"
                        name="q"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-600"><?php echo $cityCount; ?> <span>città trovate</span></p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            <?php echo htmlspecialchars($city['description'] ?: 'Città di ' . $city['province_name']); ?>
                        </p>
