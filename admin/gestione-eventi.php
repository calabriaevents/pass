...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Gestione Eventi</h1>

    <!-- I contenitori HTML verranno popolati dinamicamente da JavaScript -->
    <div id="admin-content-container">
        <!-- Qui verrà renderizzato il form e la lista degli eventi -->
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (typeof Admin !== 'undefined') {
            ...
            Admin.init(document.getElementById('admin-content-container'), 'events');
        }
    });
</script>
