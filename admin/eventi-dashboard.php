...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (typeof Admin !== 'undefined') {
            ...
            Admin.init(document.getElementById('admin-content-container'), 'dashboard');
        }
    });
</script>
