...
<head>
    ...
    <title><?php echo $query ? "Risultati per \"$query\"" : "Ricerca"; ?> - Passione Calabria</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <a href="index.php" class="flex items-center space-x-3">
                    <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-yellow-500 rounded-full flex items-center justify-center">
                        <span class="text-white font-bold">PC</span>
                    </div>
                    <div>
                        <h1 class="text-xl font-bold">Passione <span class="text-yellow-300">Calabria</span></h1>
                    </div>
                </a>

                <nav class="hidden md:flex items-center space-x-6">
                    <a href="index.php" class="hover:text-yellow-300 transition-colors">Home</a>
                    <a href="categorie.php" class="hover:text-yellow-300 transition-colors">Categorie</a>
                    <a href="province.php" class="hover:text-yellow-300 transition-colors">Province</a>
                    <a href="admin/" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-full transition-colors">Admin</a>
                </nav>
            </div>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <?php if ($query || $provinceId || $categoryId): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="text-center py-20">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 mb-4">Nessun risultato trovato</h2>
                        <p class="text-gray-600 mb-8">
                            Non abbiamo trovato contenuti che corrispondano alla tua ricerca.
                            Prova con termini diversi o esplora le nostre categorie.
                        </p>
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">Cosa vuoi scoprire della Calabria?</h2>
                    <p class="text-gray-600 mb-8">
                        Usa il modulo di ricerca qui sopra per trovare luoghi, tradizioni, eventi e tutto quello che ti interessa sulla nostra regione.
                    </p>

                    <!-- Suggested Searches -->
                    <div class="max-w-2xl mx-auto">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Ricerche suggerite:</h3>
