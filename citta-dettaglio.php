...
<body class="bg-slate-50">
    ...
    <section class="relative h-[70vh] overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="<?php echo ($heroImage !== 'assets/images/default-city-hero.jpg') ? 'image-loader.php?path=' . urlencode(str_replace('uploads_protected/', '', $heroImage)) : htmlspecialchars($heroImage); ?>" alt="<?php echo htmlspecialchars($city['name']); ?>"
