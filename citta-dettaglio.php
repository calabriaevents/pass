...
<body class="bg-slate-50">
    ...
    <section class="relative h-[70vh] overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="<?php echo (strpos($heroImage, 'assets/') === 0) ? htmlspecialchars($heroImage) : 'image-loader.php?path=' . urlencode($heroImage); ?>" alt="<?php echo htmlspecialchars($city['name']); ?>"
